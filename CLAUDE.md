...
etwa drei Varianten erst `--dry-run` zeigen und eine Bestätigung abwarten.

**Nie ungefragt einen Lauf starten, der Geld kostet** — auch keinen einzelnen
zum Ausprobieren, und auch nicht, um „schnell zu prüfen, ob es geht". Wenn du
etwas verifizieren willst, sag was es kostet und warte auf die Zusage.
